...
diff -q ${REF_F_REGULAR} ${OUTF_REGULAR} || { echo "test FAILED" ; exit 1 ; }
echo "[test OK]"
rm ${OUTF_REGULAR}
...
diff -q ${REF_F_REG_SOS} ${OUTF_REG_SOS} || { echo "test FAILED" ; exit 1 ; }
echo "[test OK]"
rm ${OUTF_REG_SOS}
...
diff -q ${REF_F_PT_WSOS} ${OUTF_PT_WSOS} || { echo "test FAILED" ; exit 1 ; }
echo "[test OK]"
rm ${OUTF_PT_WSOS}
